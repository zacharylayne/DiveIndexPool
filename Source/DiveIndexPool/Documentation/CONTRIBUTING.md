Contributing to the DiveIndexPool Repository
====

Thank you for considering contributing to the **DiveIndexPool** project! We welcome all types of contributions, including bug reports, feature requests, code contributions, documentation improvements, and other contributions.
...
1. **Check Existing Issues:** Search the [issues](https://github.com/zacharylayne/DiveIndexPool/issues) to see if the bug has already been reported.
...
1. **Search Existing Discussions:** Search the [discussions](https://github.com/zacharylayne/DiveIndexPool/discussions) to make sure your feature hasn’t already been requested.
...
## License
By contributing to the Const Type Args framework, you agree that your contributions will be licensed under the project's [MIT License](https://github.com/zacharylayne/DiveIndexPool/blob/master/LICENSE.txt).
